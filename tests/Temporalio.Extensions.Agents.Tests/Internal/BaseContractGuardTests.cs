...
/// <summary>
/// Base-contract guard suite for <c>Temporalio.Extensions.Agents</c> (plan §2.2 / §2.4,
...
public class BaseContractGuardTests
{
    ...
    public void AgentChainWalker_Detection_IsPresenceBased_NotInstanceSensitive()
    {
        ...
        var containsAgent = typeof(Temporalio.Extensions.AI.Internal.AgentChainWalker)
            .GetMethod(
                nameof(Temporalio.Extensions.AI.Internal.AgentChainWalker.Contains),
                [typeof(AIAgent)]);
