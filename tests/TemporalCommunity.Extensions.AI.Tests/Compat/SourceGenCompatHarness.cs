...
internal static class SourceGenCompatHarness
{
    ...
    {
        // The base type lives in the TemporalCommunity.Extensions.AI assembly. Walk
    ...
    ///   "snapshotName": "v0_3",
    ///   "baseTypes": {
    ///     "TemporalCommunity.Extensions.AI.Session.DurableSessionEntry": ["ai_request", "ai_response"]
    ///   }
    /// }
    /// </code>
    /// </summary>
