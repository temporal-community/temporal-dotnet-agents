...
/// <summary>
/// Base-contract guard suite for <c>Temporalio.Extensions.AI</c> (plan §2.2 / §2.4,
...
public class BaseContractGuardTests
{
    ...
    /// <see cref="Temporalio.Extensions.AI.Internal.AgentChainWalker"/> reflects by string name
