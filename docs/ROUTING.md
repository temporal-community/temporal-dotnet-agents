...
- [`DURABILITY_AND_DETERMINISM.md`](./DURABILITY_AND_DETERMINISM.md) — Why workflow code must be deterministic
- [`AGENT_SESSIONS_AND_WORKFLOW_LOOP.md`](./AGENT_SESSIONS_AND_WORKFLOW_LOOP.md) — How agent calls become durable activities
- [`SESSION_STATEBAG_AND_CONTEXT_PROVIDERS.md`](./SESSION_STATEBAG_AND_CONTEXT_PROVIDERS.md) — StateBag and AIContextProvider integration
